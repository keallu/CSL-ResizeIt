...
public abstract class Configuration<C> where C : class, new()
{
    ...
    public static C Load()
    {
        if (instance == null)
        {
            ...
            {
                Debug.Log("[Resize It!] Configuration:Load -> Exception: " + e.Message);
            }
        }
    ...
    public static void Save()
    {
        ...
        {
            Debug.Log("[Resize It!] Configuration:Save -> Exception: " + e.Message);
        }
    }
    ...
    private static string GetConfigPath()
    {
        ...
        {
            Debug.Log("[Resize It!] Configuration:GetConfigPath -> ConfigurationPath attribute missing in " + typeof(C).Name);
